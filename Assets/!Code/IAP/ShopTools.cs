...
namespace IAP
{
    internal class ShopTools : IShop, IStoreListener
    {
        ...
        public IReadOnlySubscriptionAction OnSuccessPurchase => _onSucessPurchase;
